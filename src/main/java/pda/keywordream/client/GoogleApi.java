...
public class GoogleApi {
    ...
    public List<TrendingSearchResDto> fetchTrendingSearches(){
        List<TrendingSearchResDto> trendingSearchResDtos = new ArrayList<>();
        try{
            ...
            for(int i=0; i < items.getLength(); i++){
                ...
                TrendingSearchResDto trendingSearchResDto = extractTrendingSearchResDto(item);
                if(trendingSearchResDto != null){
                    trendingSearchResDtos.add(trendingSearchResDto);
                }
            }
        } catch(Exception e){
    ...
    private TrendingSearchResDto extractTrendingSearchResDto(Element item){
        try{
            ...
            return TrendingSearchResDto.builder()
                    .title(title)
